...
import { createBitmapText, updateBitmapTextStyle } from './utils/BitmapTextFactory.js';
...
export class GameScene extends Phaser.Scene {
    ...
    updateMenuButtonLabel() {
        ...
        updateBitmapTextStyle(this.menuButton, { fontSize: targetFontSize });
    ...
    updateSettingsButtonLabel() {
        ...
        updateBitmapTextStyle(this.settingsButton, { fontSize: targetFontSize });
        if (this.layoutHeaderButtons) {
            this.layoutHeaderButtons();
        }
    }
