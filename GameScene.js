...
import { createRelicShelf, showRelicDetails, updateRelicDisplay } from './objects/RelicUI.js';
...
export class GameScene extends Phaser.Scene {
    ...
    attemptPurchaseRelic(relicId) {
        ...
        updateRelicDisplay(this);
        showRelicDetails(this, relic);
        return relic;
    }
